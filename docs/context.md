...
│   │   └── record_dataset.py           ← records teleoperated demos into a LeRobotDataset (both cameras + both arms); custom recorder (not `lerobot-record`) since hexarm shares one bus/port across arms; ✅ added (2026-08-03)
