...
| Policy training | ⏳ Todo — next up. Benchmarked real ACT training step time on this Jetson (1.29s/step measured, FP32, batch 8) — 5–10 epochs over the dataset (~17.7k–35.4k steps, per LeRobot's own epoch-based sizing guidance) projects to ~6.4–12.7h locally vs. ~30–90min on a rented RTX 4090 (<$1) or HF Jobs. Decision: train in the cloud, not on the Jetson — see context.md session-12 log entry. |
